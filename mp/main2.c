...
void displayBoard(gameStateType *pGame)
{
    ...
    printf("Current Player: %s (%s)\n", 
           pGame->nCurrentPlayer == BLUE_PLAYER ? pGame->strPlayer1Name : pGame->strPlayer2Name,
           pGame->nCurrentPlayer == BLUE_PLAYER ? "Blue" : "Red");
...
void displayPlayerCards(gameStateType *pGame, int nPlayer)
{
    ...
    printf("\n=== %s's CARDS ===\n", 
           nPlayer == BLUE_PLAYER ? pGame->strPlayer1Name : pGame->strPlayer2Name);
